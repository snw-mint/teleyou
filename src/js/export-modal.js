        ...
        body.innerHTML = `
            ...
            <div class="m3-platform-grid">
                ...
                <div class="m3-platform-card" data-platform="desktop">
                    <div class="m3-platform-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24" fill="urrentcolor"><path d="M40-120v-80h880v80zm120-120q-33 0-56.5-23.5T80-320v-440q0-33 23.5-56.5T160-840h640q33 0 56.5 23.5T880-760v440q0 33-23.5 56.5T800-240zm0-80h640v-440H160zm0 0v-440z"/></svg>
                    </div>
                    <div>
